...
const Footer = () => {
  ...
  <div className=" row align-items-center" style={{ display: "flex",marginTop:'5px', }}>
    <NavLink className="col" to='/' style={{ marginRight: "5px", textDecoration: "none",color:"#333333" }}>
      <i className="fa fa-home px-1" style={{ fontSize: '26px' }}></i>
      <p style={{ fontSize: '13px' }}><b>Home</b></p>
    </NavLink>
    <NavLink className="col" to='/about' style={{ marginRight: "5px", textDecoration: "none",color:"#333333" }}>
      <i className="fa fa-address-card-o px-1" style={{ fontSize: '26px' }}></i>
      <p style={{ fontSize: '13px' }} ><b>About</b></p>
    </NavLink>
    <NavLink className="col" to='/services' style={{ marginRight: "5px", textDecoration: "none",color:"#333333" }}>
      <i className="fa fa-briefcase px-3" style={{ fontSize: '26px' }}></i>
      <p className='px-1' style={{ fontSize: '12px' }}><b>Find Job</b></p>
    </NavLink>
    <NavLink className="col" to='/contact' style={{ marginRight: "5px", textDecoration: "none",color:"#333333" }}>
    ...
    <NavLink className="col" to='/users' style={{ textDecoration: "none",color:"#333333" }}>
      <i className="fa fa-user-circle px-2" style={{ fontSize: '26px' }}></i>
